  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Focus state.
        "has-[[data-slot=input-group-control]:focus-visible]:border-repo-accent has-[[data-slot=input-group-control]:focus-visible]:ring-repo-accent/50 has-[[data-slot=input-group-control]:focus-visible]:ring-[3px]",
