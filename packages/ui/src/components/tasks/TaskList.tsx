...
export function TaskList({
  ...
  const statusCollapsedState = persistCollapsedState
    ? storeStatusCollapsedState
    : localStatusCollapsed
  const parentCollapsedState = persistCollapsedState
    ? storeParentCollapsedState
    : localParentCollapsed
