...
describe("protocol", () => {
  ...
  test("makeRequest / isRequest / decodeRequest", () => {
    const req = makeRequest("edit-text", { id: "UI-1", field: "title", value: "X" }, "r-1")
  ...
  test("makeOk / makeError / isReply / decodeReply", () => {
    const req = makeRequest("edit-text", { id: "UI-1", field: "title", value: "T" }, "r-2")
...
describe("server/protocol", () => {
  ...
  test("makeRequest and decodeRequest round-trip", () => {
    const req = makeRequest("edit-text", { id: "UI-9", field: "title", value: "X" }, "r-9")
  ...
  test("makeOk and makeError create valid replies", () => {
    const req = makeRequest("edit-text", { id: "UI-1", field: "title", value: "T" }, "r-10")
