...
describe("views/detail notes edit", () => {
  test("enables editing, saves, and persists notes", async () => {
    ...
    const editable = /** @type {HTMLDivElement} */ (mount.querySelector(".notes .editable"))
    editable.click()

    const ta = /** @type {HTMLTextAreaElement} */ (mount.querySelector(".notes textarea"))
    ...
    const md = /** @type {HTMLDivElement} */ (mount.querySelector(".notes .md"))
